...
addLayer("h", {
    ...
    upgrades: {
        ...
        13: {
            ...
            cost: new Decimal(5),
            effect() {
                return player.points.add(1).pow(0.08).log10().add(1)
            },
            effectDisplay() { 
                return format(upgradeEffect(this.layer, this.id)) + "x" 
            },
...
addLayer("nh", {
    ...
    symbol: `<img src="resources/icon/nh3.png" alt="NH" tag="icon-img">`, // This appears on the layer's node. Default is the id with the first letter capitalized.
    position: 0, // Horizontal position within a row. By default, it uses the layer id and sorts in alphabetical order.
    branches: ["n","h"],
    startData() { 
        return {
...
addLayer("co", {
    ...
    symbol: `<img src="resources/icon/co2.png" alt="CO" tag="icon-img">`, // This appears on the layer's node. Default is the id with the first letter capitalized.

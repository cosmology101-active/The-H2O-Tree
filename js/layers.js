    ...
    tabFormat: {
        ...
        "Water Cycle": {
            ...
            content: [
                ...
                "blank",
                ["display-text",
                    function() { return 'You have ' + format(player.w.watervapor) + ' water vapor, boosting vapor generation by ' + format(player.w.watervapor.pow(0.4).log10()); },
                    { "font-size": "12px" },
                ],
                "blank",
                "blank",

...
addLayer("nh", {
    ...
    symbol: `<img src="resources/icon/nh3.png" alt="NH">`, // This appears on the layer's node. Default is the id with the first letter capitalized.
    position: 0, // Horizontal position within a row. By default, it uses the layer id and sorts in alphabetical order.
    branches: ["n","h"],
    startData() { 
        return {
...
addLayer("co", {
    ...
    symbol: `<img src="resources/icon/co2.png" alt="CO">`, // This appears on the layer's node. Default is the id with the first letter capitalized.
